...
if (isset($_SESSION['user_id'])) {
    ...
    try {
        $stmt = $pdo->prepare("
            SELECT cart.id, cart.product_id, cart.quantity, cart.price, product.name, product.author, product.pages, product.year1, product.image 
            FROM cart 
                        ...
                        <div class="container">
                            <div class="cart-item">
                                ...
                                <div class="cart-item-details">
                                    ...
                                    <div class="cart-item-author">Название: ' . htmlspecialchars($row['author'], ENT_QUOTES, 'UTF-8') . '</div>
                                    <div class="cart-item-pages">Коллекция: ' . htmlspecialchars($row['pages'], ENT_QUOTES, 'UTF-8') . '</div>
                                    <div class="cart-item-year">Размер: ' . htmlspecialchars($row['year1'], ENT_QUOTES, 'UTF-8') . '</div>
